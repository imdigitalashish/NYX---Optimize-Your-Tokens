...
|---|--------|---------|-----------|
| T1 | density/accuracy cliff | ✅ finding | naive max-pack over-packs; knee ~22k chars/pg |
...
| T9 | glyph-size unlock | ✅ finding | Opus needs 8-12px; GPT fails |
...
| T18 | verbatim recall rate | ✅ | 80-87% GUID recall (vs weak-encoder 0/15) |
...
lossy for exact strings" assumption (weak-encoder 0/15, DeepSeek-OCR 60%@20x) is largely a
